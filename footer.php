        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?= do_shortcode('[contact-form-7 id="b649a0d" title="Есть вопросы? Напишите нам!"]'); ?>
            </div>
        </div>
        <footer>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('link_instagram', 2); ?>" target="_blank" class="footer__social-item">
                            ...
                            <a href="<?php the_field('link_facebook', 2); ?>" target="_blank" class="footer__social-item">
                            ...
                            <a href="<?php the_field('link_youtube', 2); ?>" target="_blank" class="footer__social-item">
    ...
    <!-- подключаем api для карты -->
      <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCsLztfO7Xke22AAKUzuo5BwvKBNvDqsTQ&callback=Function.prototype"></script>
