...
<html lang="ru">
	<head>
        ...
        <!-- вывел название сайта и краткое описание из админки в название вкладки -->
		<title><?php bloginfo('name'); echo" | "; bloginfo('description'); ?></title> 
        <meta name="theme-color" content="#c9e0e04d">
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
        <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
        <!-- вставил пхп код для создания динамического пути к файлам -->
                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <!-- адрес почты достаем при помощи the_field с аргументом mail и 2 (2 - это id главной страницы из адресной строки) -->
